...
if (isset($cur_curs))
{
    ...
    $fp	 = APP_PATH . "/images/vipusknik/" . '*.{jpg,png,gif}';
...
foreach ($towns->getAll() as $t)
{
    ...
    $nav .= '<li class="nav-item">'
	    . '<a class="nav-link ' . $active . '" href="' . WWW_ADMIN_PATH . 'vipusknik/curses/' . $t->link . '">'
	    . $t->name_ua . '</a>'
	    . '</li> ';
}
$nav	 .= "</ul>";
...
if (isset($town)):
  ...
  <div class="dropdown-menu scrollable-menu">';
	...
	$but .= '<a class="dropdown-item" href="' . WWW_ADMIN_PATH . 'vipusknik/curses/' . $town . "/" . $li->link . '">' . $li->name_ru . '</a>';
    }
    $but	 .= '</div></div> ';
