...
var nicImageOptions = {
    buttons: {
        'image': {name: 'edit Image', type: 'nicImageButton', tags: ['IMG']}
    }
...
var nicImageButton = nicEditorAdvancedButton.extend({addPane: function () {
        ...
        this.addForm({"": {type: "title", txt: "Add/Edit Image"}, width: {type: "text", txt: "Width", style: {width: "150px"}}, height: {type: "text", txt: "Height", style: {width: "150px"}}, src: {type: "text", txt: "URL", value: "http://", style: {width: "150px"}}, alt: {type: "text", txt: "Alt Text", style: {width: "100px"}}, align: {type: "select", txt: "Align", options: {none: "Default", left: "Left", right: "Right"}}}, this.im)
    }, submit: function (B) {
        ...
        if (this.im) {
            ...
            this.im.setStyle({width: this.inputs.width.value, height: this.inputs.height.value});
        }
    }});
...
var nicUploadButton = nicEditorAdvancedButton.extend({
    ...
    onUploaded: function (options) {
        ...
        if (this.im) {
            ...
            this.im.setStyles({width: (w && options.width) ? Math.min(w, options.width) : ''});
        }
    }
});
