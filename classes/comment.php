...
class comment extends db {
	...
	return '
			...
			<div class="comment media mt-5">
				' . $link_open . '
				<img class="mr-3 rounded-circle" src="http://www.gravatar.com/avatar/' . md5(strtolower(trim($d['email']))) . '?s=30&amp;d=' . urlencode($url) . '" />
				' . $link_close . '
			    <div class="media-body">
					...
					<p class="cbody">' . $d['body'] . '</p>	<div class="cfoot"><a href="#' . $d['id'] . '" id="' . $d['id'] . '" class="replay btn btn-warning btn-sm px-3">' . $ansver . '</a></div></div></div>';
    }
